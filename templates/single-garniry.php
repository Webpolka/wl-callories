...
if (have_posts()):
    while (have_posts()):
        ...
        <article class="garniry-single" style="position:relative; z-index: 1;">
            ...
            <div class="garniry-ingredients">
                <h2>Ингредиенты</h2>
                <p><?php echo text_to_ul(esc_html($ingredients)); ?></p>
            </div>

            <div class="garniry-recipe">
                <h2>Рецепт</h2>
